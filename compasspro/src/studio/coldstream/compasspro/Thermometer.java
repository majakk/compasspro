...
public final class Thermometer extends View {
	...
	private int totalNotches = 24;
	private int incrementPerLargeNotch = 3;
	private int incrementPerSmallNotch = 1;
	private float degreesPerNotch = 360.0f / totalNotches;	
	
	private int scaleCenterValue = 0; // the one in the top center (12 o'clock)
	private int scaleMinValue = 0;
	private int scaleMaxValue = 360;
	private String scaleUpperTitle = "Compass Pro";
	private String scaleLowerTitle = "Coldstream Solutions";
	private int scaleColor = 0xff8888ee;
	...
	private void initDrawingTools() {
		...
		titlePaint.setColor(0xff8888ee);
		...
		logo = BitmapFactory.decodeResource(getContext().getResources(), R.drawable.coldstream);
		logoMatrix = new Matrix();
		logoScale = (1.0f / logo.getWidth()) * 0.25f;;
		...
		handPath1 = new Path();
		handPath1.moveTo(0.5f + 0.001f, 0.5f);
		handPath1.lineTo(0.5f - 0.025f, 0.5f);
		handPath1.lineTo(0.5f - 0.002f, 0.5f - 0.32f);
		handPath1.lineTo(0.5f, 0.5f - 0.32f);
		handPath1.lineTo(0.5f + 0.001f, 0.5f);
		...
		handPath2 = new Path();
		handPath2.moveTo(0.5f - 0.001f, 0.5f);
		handPath2.lineTo(0.5f + 0.025f, 0.5f);
		handPath2.lineTo(0.5f + 0.002f, 0.5f - 0.32f);
		handPath2.lineTo(0.5f, 0.5f - 0.32f);
		handPath2.lineTo(0.5f - 0.001f, 0.5f);
		...
		handPath3 = new Path();
		handPath3.moveTo(0.5f + 0.001f, 0.5f);
		handPath3.lineTo(0.5f - 0.025f, 0.5f);
		handPath3.lineTo(0.5f - 0.002f, 0.5f + 0.32f);
		handPath3.lineTo(0.5f, 0.5f + 0.32f);
		handPath3.lineTo(0.5f + 0.001f, 0.5f);
		...
		handPath4 = new Path();
		handPath4.moveTo(0.5f - 0.001f, 0.5f);
		handPath4.lineTo(0.5f + 0.025f, 0.5f);
		handPath4.lineTo(0.5f + 0.002f, 0.5f + 0.32f);
		handPath4.lineTo(0.5f, 0.5f + 0.32f);
		handPath4.lineTo(0.5f - 0.001f, 0.5f);
		//handPath.addCircle(0.5f, 0.5f, 0.025f, Path.Direction.CW);
	...
	private void drawFace(Canvas canvas) {		
		...
		rimCirclePaint.setColor(0xff8888ee);
	...
	private void drawLogo(Canvas canvas) {
		...
		LightingColorFilter logoFilter = new LightingColorFilter(0xff222266, color);
	...
	private void moveHand() {
		...
		/*if (lastHandMoveTime != -1L) {
			...
			if (Math.abs(handVelocity) < 990.0f) {
				handAcceleration = 25.0f * (handTarget - handPosition);
			} else {
